...
export const THREAT_SVGS = {
  ...
  'ZIRCON': `<img src="/zircon.png" style="width: 200%; height: 200%; position: absolute; top: -50%; left: -50%; object-fit: contain; filter: drop-shadow(0 0 4px #ff0000) brightness(1.2); mix-blend-mode: screen;" />`,
