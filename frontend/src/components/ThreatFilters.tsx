...
export default function ThreatFilters() {
  ...
  return (
    <div className="absolute left-0 bottom-36 md:top-28 md:bottom-auto md:left-6 z-20 flex overflow-x-auto md:overflow-visible w-full px-3 md:w-auto md:px-0 scrollbar-hide">
