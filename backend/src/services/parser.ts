...
function detectThreatType(text: string): ParsedThreat['type'] | null {
  ...
  if (t.match(/(відбій|чисто|немає загроз|спокійно|зник|поки чисто|не фіксується|локаційно втрачено)/)) return 'INFO';
