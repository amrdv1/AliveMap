...
const SLANG_MAP: Record<string, string> = {
  // Київ
  'троя': 'київ', 'троящина': 'київ', 'троєщина': 'київ', 'дврз': 'київ',
  'оболонь': 'київ', 'позняки': 'київ', 'печерськ': 'київ', 'поділ': 'київ',
  'дарниця': 'київ', 'борщагівка': 'київ', 'відрадний': 'київ', 'святошин': 'київ',
  'куренівка': 'київ', 'виноградар': 'київ', 'нивки': 'київ', 'солом\'янка': 'київ',
  'теремки': 'київ', 'лук\'янівка': 'київ', 'русанівка': 'київ', 'березняки': 'київ',
  'осокорки': 'київ', 'харківський': 'київ', 'воскресенка': 'київ', 'лісовий': 'київ',
  'шулявка': 'київ', 'кардачі': 'київ',
  
  // Харків
  'салтівка': 'харків', 'хтз': 'харків', 'олексіївка': 'харків', 
  'павлове поле': 'харків', 'рогань': 'харків', 'холодна гора': 'харків', 
  'нові будинки': 'харків', 'баварія': 'харків',
  
  // Одеса
  'таїрова': 'одеса', 'котовського': 'одеса', 'поселок': 'одеса',
  'черемушки': 'одеса', 'пересип': 'одеса', 'лузанівка': 'одеса',
  'молдаванка': 'одеса', 'аркадія': 'одеса', 'фонтан': 'одеса',
  
  // Запоріжжя
  'бабурка': 'запоріжжя', 'космос': 'запоріжжя', 'піски': 'запоріжжя',
  'кічкас': 'запоріжжя', 'бородинський': 'запоріжжя', 'шевчик': 'запоріжжя',
  
  // Львів
  'сихів': 'львів', 'левандівка': 'львів', 'рясне': 'львів',
  'майорівка': 'львів', 'знесіння': 'львів', 'наукова': 'львів',
  
  // Дніпро
  'тополь': 'дніпро', 'перемога': 'дніпро', 'парус': 'дніпро',
  'сокіл': 'дніпро', 'лівобережний': 'дніпро', 'придніпровськ': 'дніпро',
  'краснопілля': 'дніпро', 'покровський': 'дніпро', 'комунар': 'дніпро',
  
  // Миколаїв
  'водопій': 'миколаїв', 'ліски': 'миколаїв', 'намив': 'миколаїв',
  'соляні': 'миколаїв', 'матвіївка': 'миколаїв', 'тернівка': 'миколаїв',
